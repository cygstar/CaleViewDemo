...
class ColorfulActivity : BaseActivity(), OnCalendarSelectListener, OnYearChangeListener, View.OnClickListener {
    ...
    override val layoutId: Int
        get() = R.layout.activity_colorful
    ...
    companion object {
        fun show(context: Context) {
            context.startActivity(Intent(context, ColorfulActivity::class.java))
        }
    }
}
