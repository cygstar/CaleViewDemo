...
class MixActivity : BaseActivity(), OnCalendarSelectListener, OnYearChangeListener, View.OnClickListener {
    ...
    override fun initView() {
        ...
        mCalendarView.setOnClickCalendarPaddingListener(object : OnClickCalendarPaddingListener {
    ...
    companion object {
        fun show(context: Context) {
            context.startActivity(Intent(context, MixActivity::class.java))
        }
    }
}
