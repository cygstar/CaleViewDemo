...
class IndexActivity : BaseActivity(), OnCalendarSelectListener, OnCalendarLongClickListener, OnYearChangeListener, View.OnClickListener {
    ...
    override fun onCalendarLongClick(calendar: Calendar) {
        Log.e("onDateLongClick", "  -- " + calendar.day + "  --  " + calendar.month)
    }
